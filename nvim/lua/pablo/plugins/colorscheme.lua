    ...
    opts = {
      ...
      groups = {
        all = {
          ...
          TelescopeBorder = { fg = "#e6edf7", bg = "NONE" },
          TelescopePromptBorder = { fg = "#e6edf7", bg = "NONE" },
          TelescopeResultsBorder = { fg = "#e6edf7", bg = "NONE" },
          TelescopePreviewBorder = { fg = "#e6edf7", bg = "NONE" },
          TelescopeTitle = { fg = "#e6edf7", bg = "NONE" },
          TelescopePromptTitle = { fg = "#e6edf7", bg = "NONE" },
          TelescopeResultsTitle = { fg = "#e6edf7", bg = "NONE" },
          TelescopePreviewTitle = { fg = "#e6edf7", bg = "NONE" },
