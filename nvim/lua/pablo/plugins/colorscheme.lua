    ...
    opts = {
      ...
      groups = {
        all = {
          ...
          TelescopeBorder = { fg = palette.border, bg = "NONE" },
          TelescopePromptBorder = { fg = palette.border, bg = "NONE" },
          TelescopeResultsBorder = { fg = palette.border, bg = "NONE" },
          TelescopePreviewBorder = { fg = palette.border, bg = "NONE" },
